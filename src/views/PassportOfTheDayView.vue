<template>
    <main v-if="passport" class="flex flex-col gap-4 text-center h-screen text-white ">
        <h1 class="mt-20 mb-8text-4xl">Passport of the day</h1>
        <div v-if="!submitted">
            <PassportVue :records="passport.records" class="max-h-[500px] overflow-scroll"/>
        ...
        <div v-else class="flex flex-col gap-5 place-items-center">
